...
---
Select the following link to download this indicator data in an accessible format:<br>[4.1.1 Percentage of children and adolescents achieving at least the expected proficiency level in English and Mathematics at ages 7 and 11 by sex (CSV 6.708 kB)](https://sdg-bristol.github.io/sdg-data-bristol/en/data/4-1-1.csv)